...
(() => {
    ...
    window.addEventListener('load', () => {
        ...
        links[0].addEventListener("click", () =>{
            window.open("https://apkcabal.com.ng/gta-san-andreas-apk-data-highly-compressed/");
        });
        links[1].addEventListener("click", () => {
            window.open("https://apkvision.com/games/action/grand-theft-auto-san-andreas-apk-106-2824/");
        });
