...
(() => {
    ...
    window.addEventListener('load', () => {
        ...
        links[0].addEventListener("click", () =>{
            window.open("https://androidfunz.com/gta-vice-city-lite-apkobb-just-200mb-highly-compressed-links/");
        });
        links[1].addEventListener("click", () => {
            window.open("https://m.apkshub.com/gta-vice-city/com.rockstargames.gtavc");
        });
